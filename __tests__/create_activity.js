...
test("Activity Creator", async () => {
    ...
    createActivityDetailsInput: [
      {
        ...
        maxAge: 50,
        minAge: 20,
        selectedTraits: "{exercise :regularly}",
        startDate: fdate,
        smoking: "oneDown",
        drinking: "oneDown",
        invitedFriends: "[]",
        ...
        location: {
          create: {
            node: {
              address_line1: "300 E Lake St",
              address_line2: "",
              city: "Harbor Springs",
              state: "MI",
              country: "United States",
              zip_code: "49740",
              loc: "45.4351647,-84.9859358",
            },
          },
        },
      },
  ...
  const res = await axios({
    method: "post",
    url: `http://103.72.79.12/api/create_activity`,
    data: queryParams,
    headers: {
      action: "create",
